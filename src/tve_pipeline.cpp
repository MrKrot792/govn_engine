...
{
    vkDestroyShaderModule(tveDevice.device(), vertShaderModule, nullptr);
    vkDestroyShaderModule(tveDevice.device(), fragShaderModule, nullptr);
    vkDestroyPipeline(tveDevice.device(), graphicsPipeline, nullptr);
}
                                         ...
                                         const std::string &fragFilepath, const PipelineConfigInfo &configInfo)
{
    ...
    auto bindingDescriptions = TveModel::Vertex::getBindingDescriptions();
    auto attributeDescriptions = TveModel::Vertex::getAttributeDescriptions();
...
void TvePipeline::defaultPipelineConfigInfo(PipelineConfigInfo& configInfo)
{
